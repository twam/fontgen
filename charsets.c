...
void charset_load_iso8859_1(character_t** characters, size_t* characters_size) {
	uint16_t iso8859_1_ucs4[] = {
		...
		0x0070, 0x0071, 0x0072, 0x0073, 0x0074, 0x0075, 0x0076, 0x0077, 0x0078, 0x0079, 0x007A, 0x007B, 0x007C, 0x007D, 0x007E,
		        0x00A1, 0x00A2, 0x00A3, 0x00A4, 0x00A5, 0x00A6, 0x00A7, 0x00A8, 0x00A9, 0x00AA, 0x00AB, 0x00AC,         0x00AE, 0x00AF,
	...
	for (size_t i = 0; i < sizeof(iso8859_1_ucs4)/sizeof(uint16_t); ++i) {
		character_add(characters, characters_size, iso8859_1_ucs4[i]);
	}
}
...
void charset_load_cp850(character_t** characters, size_t* characters_size) {
	uint16_t cp850_ucs4[] = {
		        0x263A, 0x263B, 0x2665, 0x2666, 0x2663, 0x2660, 0x2022, 0x25D8, 0x25CB, 0x25D9, 0x2642, 0x2640, 0x266A, 0x266B, 0x263C,
	...
	for (size_t i = 0; i < sizeof(cp850_ucs4)/sizeof(uint16_t); ++i) {
		character_add(characters, characters_size, cp850_ucs4[i]);
	}
}
...
void charset_load_cp437(character_t** characters, size_t* characters_size) {
	...
	for (size_t i = 0; i < sizeof(cp437_ucs4)/sizeof(uint16_t); ++i) {
		character_add(characters, characters_size, cp437_ucs4[i]);
	}
